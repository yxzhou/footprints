...
public class JumpGameII {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < arr.length; i++) {
            System.out.println("\n -" + i + "-The non-negative integers array is: " + Misc.array2String(arr[i]));

            System.out.println("The minimum number of jumps is " + service.jump_X(arr[i]));
            System.out.println("The minimum number of jumps is " + service.jump_n(arr[i]));
        }
    }
