...
public class CampusBikes {
    ...
    public int[] assignBikes(int[][] workers, int[][] bikes) {
        ...
        PriorityQueue<Entry> minHeap = new PriorityQueue<>(n * m, (e1, e2) -> e1.distance == e2.distance ? 
                (e1.workerId == e2.workerId ? e1.bikeId - e2.bikeId : e1.workerId - e2.workerId) : e1.distance - e2.distance);
