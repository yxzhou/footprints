...
public class XOR {
    ...
    /**
     * 有n种长度的棍子, 其中n-1种长度的有3根,剩下1种长度的只有2根.求那个长度 (or 一个全是32位整数的大数组，除了其中一个数字出现2次外，其余
     * 的数字都出现了3次。如何找出那个只出现了2次的数字？) (or
     ...
     * multiple of 3, are the bits of number with single occurrence.
     *
     * 
