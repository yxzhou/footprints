...
public class WordSearchII {
    ...
    public List<String> findWords_trie_n(char[][] board, String[] words) {
        ...
        for(int i=0; i<m; i++){
            for(int j=0; j<n; j++){
               dfs(board, visited, new StringBuilder(), i, j, trie.root, result);
            }
        }
    ...
    private void dfs(char[][] board, boolean[][] visited, StringBuilder str, int i, int j, TrieNode trie, Set<String> result){
        int m=board.length;
        int n=board[0].length;
