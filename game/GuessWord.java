 ...
 *
 * Thoughts:
 *   There are 100 possible words, to every word, w, call master.guess(w), it returns 0, 1, - -, or 6, let suppose it return x.  0 <= x <= 6
 *   The secret is in the list,  check the secret and w,  it should return x, too.
 *   So after it got x with master.guess, the possible list will be narrow down
 *
 *   To w, check with the other 99 words, some
 *
 */
