 ...
 *
 ...
 2) but we don’t want the same host to dominate the results. Write a function that will reorder the list so that a host shows up at most once on a page if possible, but
 3) otherwise preserves the ordering. Your program should return the new array and print out the results in blocks representing the pages.
...
//            }
    ...
    public static void main(String[] args) {
        ...
        List<List<String>> result = sv.paging_n(lines, 5);
