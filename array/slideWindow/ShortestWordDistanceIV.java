 ...
 * return the shortest substring that includes these three words in the order.

    word1 and word2 and word3 maybe are the same and they represent individual words in the list.
    
    For example,
    
    Assume that words = ["practice", "makes", "perfect", "coding", "makes"].
    
    Given word1 = "makes", word2 = "coding", word3 = "makes", return 3.
